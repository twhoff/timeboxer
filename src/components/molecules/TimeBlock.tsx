...
interface TimeBlockProps {
    ...
    className?: string // Optional className prop for dynamic styling
}
...
export const TimeBlock: React.FC<TimeBlockProps> = ({
    ...
    return (
        <div
            ...
            className={`time-block ${className}`} // Apply dynamic className
            style={{ top: `${top}px`, height: `${height}px` }} // Ensure styles are in px
        >
            <button
                className="bin-icon"
                onClick={onDelete}
